...
public class DBAdapter2 {
    ...
    public static final String KEY_BKID ="bkid";

   // public static final String KEY_DATE = "date";

    public static final String[] ALL_KEYS = new String[] {KEY_ROWID,KEY_EMAIL,KEY_HEAD,KEY_BKID,KEY_TOTAL,KEY_MOVIE};
   ...
   // public static final int COL_DATE=2;
    ...
    private static final String DATABASE_CREATE_SQL =
            "CREATE TABLE " +DATABASE_TABLE+" (" + KEY_ROWID + " INTEGER PRIMARY KEY, " + KEY_EMAIL + " TEXT, " + KEY_HEAD + " TEXT, "+ KEY_BKID+ " TEXT, " + KEY_TOTAL + " TEXT, " + KEY_MOVIE+ " TEXT" + ");";
    ...
    public long insertRow(String email)
    {
    ...
    public long insertRow_details(String head,String movie,String total,String bid)
    {
        ...
        initialValues.put(KEY_BKID,bid);
        //initialValues.put(KEY_DATE,date);
