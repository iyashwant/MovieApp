...
public class ImageAdapter extends BaseAdapter {
        ...
        public ImageAdapter(Context c,String[] movieName,String[] Imageid )
        {
            mContext = c;
                ...
                parent)
        {
            ...
            if (convertView == null) { // if it's not recycled, initialize some attributes
                ...
                myV = inflater.inflate(R.layout.grid_layout, parent, false);
            } else {
                myV = (View) convertView;
            }
            TextView text = (TextView)myV.findViewById(R.id.grid_item_label);
            text.setText(movieName[position]);
            ImageView image = (ImageView)myV.findViewById(R.id.grid_item_image);
